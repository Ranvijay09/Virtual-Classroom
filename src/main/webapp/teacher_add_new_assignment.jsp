    ...
    <body>
        ...
        <div class="container" style='margin-top:70px'>
            ...
            <div class="row">
                ...
                <div class="col-sm-9" >
                    <h3 class="text-primary"><i class="fa fa-plus-circle"></i> Add New Assignment </h3><hr> 
                    <div class="row col-md-12">
                        <div class="col-md-2"></div>
                        <div class="col-md-8 ">

                            <% if (session.getAttribute("teacher_ana_msg") != null) {%>
                            <div class='alert alert-danger'><strong><%=session.getAttribute("teacher_ana_msg")%></strong> </div>
                                    <% session.setAttribute("teacher_ana_msg", null);
                                        }%>
                            <form role="form" action="teacher_add_new_assignment_act.jsp" method="post">
                                <div class="form-group">
                                    <label for="asgnmt_title" class="text-primary">Assignment Title</label>
                                    <input class="form-control" name="asgnmt_title" id="asgnmt_title" type="text" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" cols="100" class="form-control" id="asgnmt_desc" name="asgnmt_desc" required></textarea>
                                </div>
                                    <div class="form-group">
                                        <label for="duetime" class="text-primary">Due Date Time</label>
                                        <input class="form-control" id="duetime" name="duetime" type="datetime-local" value="" required>
                                    </div>
