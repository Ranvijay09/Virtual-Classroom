    ...
    <body>
        ...
        <div class="container" style='margin-top:70px'>
            ...
            <div class="row">
                ...
                <div class="col-sm-9" >
                    <h3 class="text-primary"><i class="fa fa-plus-circle"></i> Add New Notes </h3><hr> 
                    <div class="row col-md-12">
                        <div class="col-md-2"></div>
                        <div class="col-md-8 ">

                            <% if (session.getAttribute("teacher_an_msg") != null) {%>
                            <div class='alert alert-danger'><strong><%=session.getAttribute("teacher_an_msg")%></strong> </div>
                                    <% session.setAttribute("teacher_an_msg", null);
                                        }%>
                            <form role="form" action="UploadNotes" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="notes_title" class="text-primary">Notes Title</label>
                                    <input class="form-control" name="notes_title" id="notes_title" type="text" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="notes_desc" class="text-primary">Description</label>
                                    <textarea rows="5" cols="100" class="form-control" id="notes_desc" name="notes_desc" required maxlength="999" style="resize:none"></textarea>
                                </div>
                                <div class="form-group">
